...
?>
        ...
        <div class="text-primary">
            <div class="event" id="creationDeCompte" style="cursor:pointer; font-size: 20px; padding-bottom: 10px; text-align: right;">creer un compte</div>
            <div class="event" id="connexion" style="cursor:pointer; font-size: 20px; padding-bottom: 10px; text-align: right;">se connecter</div>

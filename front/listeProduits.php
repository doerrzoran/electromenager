  ...
  <body>
    ...
    function tab(newArr){
      for(let i = 0; i < newArr.length; i++){
        ...
        var form = '<form action="../back/deleteProduct.php" method="POST" enctype="multipart/form-data"><input id="id" type="hidden" name="id" value="' + arr['id'] + '"><button type ="submit">suppprimer ce produit</button></form>';
